...
const questions = [
    {
        questao: "Você já usou cigarro eletrônico?",
        respostas:[
            {opcao:"sim"},
            {opcao:"não"}
    ...
    {
        questao: "Como você acha que o uso de cigarro eletrônico pode afetar sua vida escolar?",
        respostas:[
    ...
    {
        questao: "Você gostaria de receber mais informações sobre os riscos e danos associados ao uso de cigarros eletrônicos?",
        respostas:[
            {opcao:"Sim"},
            {opcao:"Não, pra quê?"}            
        ]
